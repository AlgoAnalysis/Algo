...
public enum JapaneseTimeFrameType {
	...
	ONE_HOUR(60,"1 hour"),
	FOUR_HOURS(60*4,"4 hours"),
	ONE_DAY(60*24,"day"),
	ONE_WEEK(60*24*7,"week")/*,
	...
	private JapaneseTimeFrameType(int valueInMinutes,String valueString){
		...
		if(valueInMinutes == WEEK_IN_MINUTES) // one week - TODO, check way we can't use this == ONE_WEEK ???
		{
	...
	{
		long dateInMinutes = date.getTime()/MINUTES_IN_MILISEC +  timeOffsetFromZeroDateInMinutes;
		long newDateInMinutes = ((long)dateInMinutes/valueInMinutes) * valueInMinutes - timeOffsetFromZeroDateInMinutes;
