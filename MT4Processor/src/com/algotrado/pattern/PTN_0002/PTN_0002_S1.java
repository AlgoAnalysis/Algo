...
public class PTN_0002_S1 extends PTN_0002_Main implements IPatternFirstState {
	...
	public PTN_0002_S1(Object[] parameters,PatternManager patternManager) {
	...
	public APatternState getNextState() {
		return new PTN_0002_S2(parameters,patternManager,japanese);
	}
	...
	public APatternState getCopyPatternState() {
		return new PTN_0002_S1(parameters,patternManager);
	}
